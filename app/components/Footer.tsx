...
export default function Footer() {
  return (
    <footer className='bg-brand-espresso text-white py-12 mt-20'>
      <div className='max-w-6xl mx-auto px-8'>
        <div className='flex flex-col md:flex-row justify-between items-center gap-6'>
          {/* Brand/Copyright */}
          <div className='text-center md:text-left'>
            <Link href='/' className='font-raleway text-2xl font-bold hover:text-brand-gold transition-colors mb-2 block'>
              Assembly Required
            </Link>
