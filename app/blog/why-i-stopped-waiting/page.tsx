    ...
    <main className='min-h-screen bg-brand-warmGray'>
      ...
      <article className='max-w-3xl mx-auto px-8 py-16'>
        ...
        <div className='prose prose-lg max-w-none'>
          ...
          <p className='mb-4 text-brand-darkBrown/90 leading-relaxed'>
          ...
          <p className='mb-8 text-brand-darkBrown/90 leading-relaxed'>
          ...
          <p className='mb-12 text-brand-darkBrown/90 leading-relaxed'>
